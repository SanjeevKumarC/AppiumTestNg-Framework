...
public class LG004_Verifying_User_Is_Able_To_Get_Error_Message_When_User_Enter_Valid_Username_But_Invalid_Password extends base{
	public static Logger log=LogManager.getLogger(LG004_Verifying_User_Is_Able_To_Get_Error_Message_When_User_Enter_Valid_Username_But_Invalid_Password.class.getName());
	...
	public void enterInvalidUsernameAndValidPassword() throws IOException, InterruptedException {
	    ...
	    lp.userNameTextfield.sendKeys(validUserName);
	    log.info("Sucessfully Entered validUserName Into userNameTextfield");
